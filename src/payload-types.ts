...
export interface Tenant {
  id: string;
  /**
   * This is the name of the store (e.g. User's Store)
   */
  name: string;
  /**
   * This is the subdomain for the store (e.g. [subdomain].biblioteka.com)
   */
  subdomain: string;
  ...
  /**
   * You cannot sell products until you have submitted your Stripe account details.
   */
...
export interface Product {
  ...
  content?: string | null;
  /**
   * Check if you wish to delete or archive this product. Archived products will not be visible to customers.
   */
...
export interface Order {
  ...
  /**
   * Stripe Checkout Session ID associated with this order.
   */
