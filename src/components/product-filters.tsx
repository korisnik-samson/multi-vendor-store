        ...
        <div className='border rounded-md bg-white'>
            ...
            <ProductFilter title='Price'>
                <PriceFilter minPrice={filters.minPrice} maxPrice={filters.maxPrice}
                             onMinPriceChange={(value): void => onChange("minPrice", value)}
                             onMaxPriceChange={(value): void => onChange("maxPrice", value)} />
            </ProductFilter>

            <ProductFilter title='Tags' className='border-b-0'>
                <TagsFilter value={filters.tags} onChange={(value): void => onChange("tags", value)} />
            </ProductFilter>
        </div>
    )
}