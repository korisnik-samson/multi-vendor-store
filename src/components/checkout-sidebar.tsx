...
export const CheckoutSidebar = ({ total, onCheckout, isCancelled, isPending }: CheckoutSidebarProps) => {
    return (
        <div className='border rounded-md overflow-hidden bg-white flex flex-col'>
            ...
            <div className='p-4 flex items-center justify-center'>
                <Button variant='elevated' disabled={isPending || isCancelled} onClick={onCheckout} size='lg'
